...
try {
    ...
    $mail->addAddress('ashishnath.sendemail@gmail.com');     //Add a recipient
...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mail->Body    = "Please use the below credentials for a/c login<br> Email: $email <br> Password: $password Form Link: http://localhost/agri/alumniform.php";
        // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
